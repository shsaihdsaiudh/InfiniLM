# 对照实验:repo 官方 marlin_quantize + uint8b128 (INT8) —— 验证 marlin kernel 在 sm_120 是否本身可用
import os
import sys
...
def run_int8_case(M, K, N, dtype, infini_dtype):
    ...
    print(f"INT8 M={M} K={K} N={N}: rel_mean={rel.item():.6f}")
...
if __name__ == "__main__":
    ...
    print("\033[92mINT8 MARLIN RAN\033[0m")
